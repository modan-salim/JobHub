    ...
    return (
        <div className='bg-white shadow-md shadow-gray-500'>
            <div className='flex items-center justify-between mx-auto max-w-7xl h-20 px-4'>
                <div>
                    <h1 className='text-4xl font-bold text-[#7c6e6b]'>
                    ...
                    </ul>
                    {
                        !user ? (
                            <div className='flex items-center gap-2'>
                                <Link to="/login"><Button variant="outline" className='text-lg'>Login</Button></Link>
                                ...
                                <PopoverContent className="w-80">
                                    <div className=''>
                                        ...
                                        <div className='flex flex-col my-2 text-gray-600'>
                                            ...
                                            <div className='flex w-fit items-center gap-2 cursor-pointer'>
                                                <LogOut />
                                                <Button onClick={logoutHandler} variant="link" className='text-lg'>
                                                    Logout
                                                </Button>
                                            </div>
                                        </div>
